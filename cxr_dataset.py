...
class MultilabelCXR(data.Dataset):
    ...
    def __init__(
        ...
        self.root = root
        self.classnames = [
            "Pericardial Effusion, Calcification",  # "心包积液及钙化",
            "Cardiac Malposition",  # 心脏位置异常",
            "Cardiomegaly",  # "心脏增大",
            "No Finding",  # "正常",
            "Pneumothorax",  # "气胸与液气胸",
            "Cavity, Cyst",  # "空洞与空腔",
            "Mediastinal Lesion",  # "纵膈病变",
            "Masses, Nodules",  # "结节与肿块",
            "Rib Fracture",  # "肋骨骨折",
            "Pulmonary Arterial and/or Venous Hypertension",  # "肺动脉和（或）肺静脉高压",
            "Consolidation",  # "肺实变",
            "Interstitial Lung Disease",  # "肺间质病变",
            "Pleural Effusion",  # "胸腔积液",
            "Pleural Hypertrophy, Adhesions, Calcification",  # "胸膜肥厚、粘连、钙化",
            "Scoliosis",  # "脊柱侧弯",
